...
class AbBatch:
    ...
    def x(self) -> torch.Tensor:
        return torch.nn.functional.one_hot(self.batch_tensor.long(), num_classes=self.vocab_size).float()
...
class HERWithLabelsBatch:
    ...
    @cached_property
    def x(self) -> torch.Tensor:
        #print("inside _batch.py")
        one_hot_x = torch.nn.functional.one_hot(self.batch_tensor.long(), num_classes=self.vocab_size).float()
